...
import GoLiveChecklist from '../windows/go-live/GoLiveChecklist';
import styles from '../windows/go-live/GoLive.m.less';
...
export default function Spinner(
  props: { visible?: boolean; delay?: number } & HTMLAttributes<unknown> = {},
) {
  const defaultProps = { visible: false, delay: 0 };
