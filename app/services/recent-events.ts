...
class RecentEventsViews extends ViewHandler<IRecentEventsState> {
  getEventString(event: IRecentEvent) {
    return {
      ...
      share: $t('has shared'),
      facebook_like: $t('has liked'),
      facebook_stars: $t('has used'),
      facebook_support: $t('has supported for %{mounths} months', { months: event.months }),
      facebook_share: $t('has shared'),
      facebook_follow: $t('has followed'),
      // Youtube
