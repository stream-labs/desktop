    ...
    <div className="s-spinner s-spinner__overlay">
      <div className="s-bars">
        <svg
          ...
          className="s-spinner--large"
          viewBox="0 0 28 40"
        >
          <path d="M0 0, l0 4, l0 -4" id="s-bar-y-path"></path>
          <rect width="4" height="40" x="0" y="0" ry="2" rx="2" className="s-spinner__bar">
            <animate
            ...
            <animateMotion begin="0s" dur="1.2s" repeatCount="indefinite">
              <mpath xlinkHref="#s-bar-y-path"></mpath>
            </animateMotion>
          </rect>
          <rect width="4" height="40" x="12" y="0" ry="2" rx="2" className="s-spinner__bar">
          ...
          <rect width="4" height="40" x="24" y="0" ry="2" rx="2" className="s-spinner__bar">
