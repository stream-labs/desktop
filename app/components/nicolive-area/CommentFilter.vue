        ...
        >
          <div class="popper">
            <ul class="popup-menu-list">
              <li class="popup-menu-item" :class="{ active: currentFilterBy === 'all' }" @click="currentFilterBy = 'all'" >
                <span>すべて</span>
              </li>
              <li class="popup-menu-item" :class="{ active: currentFilterBy === 'broadcaster' }" @click="currentFilterBy = 'broadcaster'">
                <span>放送者が登録</span>
              </li>
              <li class="popup-menu-item" :class="{ active: currentFilterBy === 'moderator' }" @click="currentFilterBy = 'moderator'">
                <span>モデレーターが登録</span>
              </li>
            </ul>
          </div>
