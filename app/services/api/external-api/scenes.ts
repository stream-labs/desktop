...
export class ScenesService {
  ...
  removeScene(id: string): SceneModel {
  ...
  sceneRemoved: Observable<ISceneItem>;
  itemAdded: Observable<ISceneItem>;
  itemRemoved: Observable<ISceneItem>;
  itemUpdated: Observable<ISceneItem>;
}

export type TSceneNodeModel = ISceneItemModel | ISceneItemFolderModel;
...
export class Scene {
  ...
  @Inject() scenesService: InternalScenesService;
