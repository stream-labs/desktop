            ...
            <Col span={24}>
              ...
              >
                <Panel
                  ...
                  showArrow={false}
                >
                  <div className="collapse-section">{essentialSourcesList}</div>
                </Panel>
                <Panel header={$t('General Sources')} key="generalSources">
                  <div className="collapse-section">{generalSourcesList}</div>
                </Panel>
                <Panel header={$t('Widgets')} key="widgets">
                  <div className="collapse-section">{widgetList}</div>
                </Panel>
                <Panel header={$t('Apps')} key="apps">
                  <div className="collapse-section">{appsList}</div>
                </Panel>
              </Collapse>
            </Col>
          </>
