      ...
      <div class="row">
        ...
        <div class="small-6 columns position--relative window-tab">
          <div class="window-toggle__wrapper">
            <div @click="onToggleBettingPreferencesWindowHandler">
        ...
        <div class="section">
          <div class="section-content">
            <BoolInput
              ...
              v-model="newBettingPreferences.settings.general.repeat_active.enabled"
            />
            <VFormGroup
              v-model="newBettingPreferences.settings.general.repeat_active.message"
              :metadata="metaData.repeat"
            />
            <VFormGroup
              :title="$t('Chat Lines')"
              v-model="newBettingPreferences.settings.general.repeat_active.chat_lines"
        ...
        <div class="section">
          <div class="section-content">
            <VFormGroup
              ...
              v-model="newBettingPreferences.settings.messages.open"
              :metadata="metaData.open"
            />
            <VFormGroup
              :title="$t('Close Message')"
              v-model="newBettingPreferences.settings.messages.close"
              :metadata="metaData.close"
            />
            <VFormGroup
              :title="$t('Cancel Message')"
              v-model="newBettingPreferences.settings.messages.cancel"
              :metadata="metaData.cancel"
            />
            <VFormGroup
              :title="$t('Win Message')"
              v-model="newBettingPreferences.settings.messages.win"
...
<script lang="ts" src="./ChatbotBettingPreferencesWindow.vue.ts"></script>
