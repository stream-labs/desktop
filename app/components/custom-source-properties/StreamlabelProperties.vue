<template>
  <div>
    ...
    <div class="input-container" v-if="labelSettings.format != null">
      ...
      <div class="input-wrapper">
        <input type="text" v-model="labelSettings.format" @input="debouncedSetSettings" />
        <div>
          <b>Tokens:</b>
          <span
    ...
    <div class="input-container" v-if="labelSettings.item_format != null">
      ...
      <div class="input-wrapper">
        <input type="text" v-model="labelSettings.item_format" @input="debouncedSetSettings" />
        <div>
          <b>Tokens:</b>
          <span
            class="streamlabel-token"
    ...
    <div class="input-container" v-if="labelSettings.item_separator != null">
      ...
      <div class="input-wrapper">
        <input type="text" v-model="labelSettings.item_separator" @input="debouncedSetSettings" />
        <div>
          <b>Tokens:</b>
          <span
            class="streamlabel-token"
    ...
    <div class="input-container" v-if="labelSettings.limit != null">
      ...
      <div class="input-wrapper">
        <input type="text" v-model="labelSettings.limit" @input="debouncedSetSettings" />
      </div>
    </div>
    <div class="input-container" v-if="labelSettings.duration != null">
      ...
      <div class="input-wrapper">
        <input type="text" v-model="labelSettings.duration" @input="debouncedSetSettings" />
      </div>
    </div>
