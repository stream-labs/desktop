import { restartApp, test, TExecutionContext, useWebdriver } from '../../helpers/webdriver/index.mjs';
import {
  click,
  clickButton,
  clickCheckbox,
...
import { HotkeysService, ScenesService } from 'app-services.js';
import { IHotkey } from 'services/hotkeys.js';
