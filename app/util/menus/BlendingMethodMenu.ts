...
export class BlendingMethodMenu extends Menu {
    ...
    appendMenuItems() {
      this.append({
          ...
          checked: this.selectionService.views.globalSelection.isBlendingMethodSelected(EBlendingMethod.Default),
          type: 'checkbox'
          });
      this.append({
          label: $t('SRGB Off'),
          ...
          checked: this.selectionService.views.globalSelection.isBlendingMethodSelected(EBlendingMethod.SrgbOff),
          type: 'checkbox'
          });
    }
  }