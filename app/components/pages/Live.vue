  ...
  <div class="live-container">
    <div class="flex__column">
      ...
      <resize-bar
        ...
        :reverse="true"
      />
      <div class="flex__item studio-controls" :style="{ flex: '0 0 ' + (height) + 'px' }">
        ...
        <div class="live-preview-container" :style="{ flex: '0 1 ' + displayWidth + 'px' }">
          <div class="studio-controls-top">
            <h4 class="studio-controls__label">{{ $t('Preview') }}</h4>
          ...
          <div class="live-display-wrapper">
            ...
            <div class="live-display-placeholder" v-else>
              <img
                class="live-display-placeholder__img live-display-placeholder__img--day"
                src="../../../media/images/sleeping-kevin-day.png"
              >
              <img
                class="live-display-placeholder__img live-display-placeholder__img--night"
                src="../../../media/images/sleeping-kevin-night.png"
              >
              <span v-if="!performanceModeEnabled">{{ $t('Your preview is currently disabled') }}</span>
              <span
                v-if="performanceModeEnabled"
              >{{ $t('Preview is disabled in performance mode') }}</span>
            </div>
          </div>
        </div>
      </div>
