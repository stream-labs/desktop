...
export default function Spinner(
  props: { visible?: boolean; delay?: number; relative?: boolean } & HTMLAttributes<unknown> = {},
) {
  const defaultProps = { visible: false, delay: 0, relative: false };
