...
enum ProfileType {
    CPU = 'CPU optimized (Reduction of the CPU load for an average video quality)',
    VQ = 'Video quality optimized (Improvement of the video quality at a very low CPU usage)',
    Balanced = 'TBD',
}
...
const CPU_profile: IProfile = { profileType: ProfileType.CPU, preset: PresetType.veryfast };
const VQ_profile: IProfile = { profileType: ProfileType.VQ, preset: PresetType.superfast };
...
const Preset: IEncoderPreset[] = [
  {
    ...
    settings: 'nal-hrd=cbr trellis=0 me=dia force-cfr=1 rc-lookahead=20 ref=1 chroma-qp-offset=0\
                 bframes=3 subme=1 b_adapt=1 mixed-refs=0 cabac=1 qpstep=4 b_pyramid=2 mbtree=1\
                  chroma_me=1 psy=1 8x8dct=1 fast_pskip=1 lookahead_threads=6',
  ...
  },
  {
    ...
    settings: 'nal-hrd=cbr trellis=0 me=dia force-cfr=1 rc-lookahead=20 ref=2 chroma-qp-offset=-2\
                 bframes=0 subme=0 b_adapt=2 mixed-refs=0 cabac=1 qpstep=4 b_pyramid=2 mbtree=0\
                  chroma_me=1 psy=0 8x8dct=0 fast_pskip=1 lookahead_threads=6',
    encoder: EncoderType.x264,
  },
  {
    profile: CPU_profile,
  ...
  },
  {
    ...
    settings: 'nal-hrd=cbr trellis=0 me=dia force-cfr=1 rc-lookahead=20 ref=0 chroma-qp-offset=-2 bframes=0 subme=1\
                 b_adapt=0 mixed-refs=0 cabac=1 qpstep=4 b_pyramid=2 mbtree=0 chroma_me=1 psy=1 8x8dct=0 fast_pskip=1\
                  lookahead_threads=6',
    encoder: EncoderType.x264,
  },
  {
    ...
    settings: 'nal-hrd=cbr trellis=0 me=dia force-cfr=1 rc-lookahead=20 ref=1 chroma-qp-offset=0 bframes=3 subme=1\
                 b_adapt=1 mixed-refs=0 cabac=1 qpstep=4 b_pyramid=2 mbtree=1 chroma_me=1 psy=1 8x8dct=1 fast_pskip=1\
                  lookahead_threads=6',
    encoder: EncoderType.x264,
  },
  {
