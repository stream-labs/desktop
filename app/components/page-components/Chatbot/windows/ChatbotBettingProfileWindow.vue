<template>
  <ModalLayout :showControls="false" :customControls="true" :containsTabs="true">
    ...
    <div slot="content">
          ...
          <div class="section">
            <div class="section-content">
              ...
              <div class="flex">
                <BoolInput
                  class="poll-checkbox"
                  :title="$t('Send chat notification when betting')"
                  v-model="newProfile.send_notification"
                />
                <i
                  class="icon-question icon-btn"
                  v-tooltip="$t('Notify a viewer that their bet has been registered in chat.')"
                />
              </div>
            </div>
          </div>
      ...
      <ChatbotBetOptionModal :option="selectedOption" :index="selectedIndex" @add="onAddedHandler"/>
    </div>
...
<script lang="ts" src="./ChatbotBettingProfileWindow.vue.ts"></script>
