    ...
    <validated-form slot="goal-properties" v-if="loaded">
      <div v-if="hasGoal && !isCharity">
        <div class="section__body">
          ...
          <button class="button button--soft-warning" @click="resetGoal()">
            {{ $t('End Goal') }}
          </button>
        </div>
      </div>

      <div v-else-if="!isCharity">
        <div class="section__body" v-if="requestState !== 'pending'">
          <validated-form ref="form" name="new-goal-form">
            ...
            <v-form-group
              ...
              :metadata="metadata.goal_amount"
            />
            <v-form-group
              v-model="goalCreateOptions.manual_goal_amount"
              :metadata="metadata.manual_goal_amount"
            />
