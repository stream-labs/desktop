...
export const conditions = () => ({
  ...
  sponsors: [{ value: 'MIN_MONTHS_SPONSORED', title: $t('Months as a member is at least <months>') }],
  fanfunding: [
  ...
  gamewisp: [
    ...
    { value: 'MIN_GAMEWISP_MONTHS_SUBSCRIBED', title: $t('Months subscribed is at least <months>') },
    { value: 'EXACT_GAMEWISP_MONTHS_SUBSCRIBED', title: $t('Months subscribed is exactly <months>') }
  ],
  donordrive: [
